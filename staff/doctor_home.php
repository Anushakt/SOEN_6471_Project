...
<body>
  ...
  <h1 class="display-5 text-left">Doctor Dashboard </h1>
 </div>
...
<nav class="nav flex-column">
  <a class="nav-link active" href="booking_confirmation.php">Booking Confirmation</a>
  <a class="nav-link" href="schedule.php">Schedule Appointment</a>
